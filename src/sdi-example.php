...
if ( ! isset($donationId)) { ?>
    ...
    <a href="http://v3-sandbox.justgiving.com/donation/direct/charity/2050?frequency=single&exitUrl=http%3A%2F%2Flocalhost:678/sdi-example.php?donationId=JUSTGIVING-DONATION-ID">Click
        here to start your SDI donation to The Demo Charity on Sandbox</a>
